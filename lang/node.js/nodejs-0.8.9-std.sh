...
SHA_PACK="2d3234adceedc2dc87284af88609ede6ecd71734"
SRC_URL="http://nodejs.org/dist/v0.8.9/node-v0.8.9.tar.gz"
DEPENDS="build-essential libssl-dev libreadline-dev"
PACKNAME="node-v0.8.9.tar.gz"
FOLDERNAME="node-v0.8.9"
